...
export var imageSlider = new mcImgSlider(sliderOptions);

function frameSize() {
  const e = document.getElementById("slider"),
    t = e?.offsetHeight,
    n = e?.offsetWidth;
  return e ? `${n}px ${t}px` : "cover";
}
...
function mcImgSlider(i) {
  ...
  lb.prototype = {
    ...
    M: function (a) {
      ...
      var b = this.a(document.domain.replace("", ""));
      try {
        (function (a, c) {
          var e =
